...
public class ComunaService {
    ...
    public Comuna guardarComuna(Comuna nueva_comuna){return comunaRepository.save(nueva_comuna); }
    public List<Comuna> verComunas() {return (List<Comuna>) comunaRepository.findAll();}
